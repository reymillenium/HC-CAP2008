...
uses
  ...
  UPuestoDeTrabajo, UDptoCapacitacion;
    ...
    then
      begin
        if (edtContrasenna.Text = edtRepetirContrasenna.Text)
          then
            begin
              if (DptoCapacitacion.ExisteElPuestoDeTrabajoConUsuario(edtUsuario.Text) = False)
                then
                  begin
                    //Creo un Puesto de Trabajo temporal
                    TempPuestoDeTrabajo:= TPuestoDeTrabajo.Create;

                    //Relleno el Puesto de Trabajo temporal
                    RellenarPuestoDeTrabajoTemporal;

                    //Llamo al procedimiento que inserta el Puesto de Trabajo
                    DptoCapacitacion.InsertarPuestoDeTrabajo(TempPuestoDeTrabajo);
                    ...
                    //Inserto la Traza
                    DptoCapacitacion.GuardarTrazaDelSistema('Creó el Puesto de Trabajo ' + '"' + Usuario + '"' + ' con privilegios de ' + Privilegios + ' y perteneciente a ' + NombreCompleto + '.');

                    //Actualizo todas las trazas
                    DptoCapacitacion.MostrarTodasLasTrazas;

                    //Destruyo el Puesto de Trabajo temporal
...
begin
  ...
  //Procedo a llenar el Puesto de Trabajo temporal con los datos de la forma.
  ...
  TempPuestoDeTrabajo.Contrasenna:= DptoCapacitacion.EncriptarSeudoaleatorio(frase);
